...
const emptyContent: ProductPageContent = {
  hero: {
    title: "",
    subtitle: "",
    imageUrl: "",
...
const Product = () => {
  ...
  const [content, setContent] =
    useState<ProductPageContent>(emptyContent);
  ...
  useEffect(() => {
    const load = async () => {
      const data =
        await getPageContent<ProductPageContent>("product");
